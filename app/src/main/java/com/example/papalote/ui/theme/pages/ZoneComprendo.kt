...
fun ComprendoScreen(
    ...
    ZoneDetailScreen(
        ...
        activities = listOf("Comprendo 1", "Comprendo 2", "Comprendo 3"),
        onMedalClick = { /* Acción específica para medallas */ },
        navController = navController,
        tokenManager = tokenManager,
        onBack = { navController.navigateUp() },
        onActivityClick = { activityName ->
            navController.navigate("comprendo_questions/$activityName")
        }
    )
}

@Composable
fun ComprendoQuestionsScreen(
    navController: NavHostController,
    tokenManager: TokenManager,
