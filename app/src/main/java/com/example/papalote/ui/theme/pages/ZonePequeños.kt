...
fun PequeñosScreen(
    ...
    ZoneDetailScreen(
        ...
        activities = listOf("Pequeños 1", "Pequeños 2", "Pequeños 3"),
        onMedalClick = { /* Acción específica para medallas */ },
        navController = navController,
        tokenManager = tokenManager,
        onBack = { navController.navigateUp() },
        onActivityClick = { activityName ->
            navController.navigate("pequeños_questions/$activityName")
        }
    )
}

@Composable
fun PequeñosQuestionsScreen(
    navController: NavHostController,
    tokenManager: TokenManager,
