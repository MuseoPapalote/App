...
fun PertenezcoScreen(
    ...
    ZoneDetailScreen(
        ...
        activities = listOf("Pertenezco 1", "Pertenzco 2", "Pertenezco 3"),
        onMedalClick = { /* Acción específica para medallas */ },
        navController = navController,
        tokenManager = tokenManager,
        onBack = { navController.navigateUp() },
        onActivityClick = { activityName ->
            navController.navigate("pertenezco_questions/$activityName")
        }
    )
}

@Composable
fun PertenezcoQuestionsScreen(
    navController: NavHostController,
    tokenManager: TokenManager,
